...
class TestStrategy(bt.Strategy):
    ...
    def next(self):
        ...
        self.log(f'self.max_value:{self.max_value[0]}')
        self.log(f'self.max_value2:{self.max_value2[0]}')
        self.log(f'self.var8:{self.var8[0]}')
