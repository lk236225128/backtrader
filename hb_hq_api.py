...
def attribute_history(security, count, unit='1d',
                      fields=['open', 'close', 'high', 'low', 'volume', 'money']):  # 获取历史行情
    return get_price(security=security, end_date=context.current_dt, frequency=unit, fields=fields, fq=fq, count=count)[
           :-1]
